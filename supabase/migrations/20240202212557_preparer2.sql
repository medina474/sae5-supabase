create or replace function public.preparer2(_semaine int)
 returns table (_preparation_id bigint, _preparation text, _tournee_id bigint, _tournee text, _produit text, _nombre bigint)
 language plpgsql
as $function$
begin

return query select p.preparation_id, p.preparation, t.tournee_id,t.tournee, p3.produit, count(p3.produit_id)
from preparations p
...
group by p.preparation_id, p.preparation, t.tournee_id, p3.produit;
