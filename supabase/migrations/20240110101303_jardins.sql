...
alter table adresses add constraint adresses_jardin_id_fkey FOREIGN KEY (jardin_id) REFERENCES jardins(jardin_id) not valid;

alter table adresses validate constraint adresses_jardin_id_fkey;
...
alter table contacts add constraint contacts_jardin_id_fkey FOREIGN KEY (jardin_id) REFERENCES jardins(jardin_id) not valid;

alter table contacts validate constraint contacts_jardin_id_fkey;
